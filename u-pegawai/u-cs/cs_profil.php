...
?>
				<div id="konten">
					<div id="kontenkiriProfil">
						<h3 class="h3Index">Profil <?php echo $_SESSION['username'];?></h3>
							...
							<table style="margin-left:10px;margin-top:38%;" >
								<tr>
									<td>
										<a href="cs_menu.php"><img src="../../images/back.png" width="10%" height="10%" alt="Kembali ke Menu CS" title="Kembali ke Menu CS"></a>
									</td>
								</tr>
							</table>
					</div>
					...
					<h3 class="h3Index">Ganti Password</h3>
						<form CELLSPACING="5px" name="ganti_pass" method="post" action="cs_ganti_password.php" onSubmit="return validasiGantiPassword()">
							 <table border="0" style="margin-left:4%;margin-top:2%;">
							   <tr>
